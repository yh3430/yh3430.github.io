...
You can see the short data description here[NOAA data description](NOAA_data.html). In addtion, you can also view the [NOAA dashboard](dashboard.html) page, which includes some interactive plot of snow depth, precipitation, maximum and minimum temperature.
